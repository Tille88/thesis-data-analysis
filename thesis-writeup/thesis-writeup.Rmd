...
The individual effects have not affected the estimates, but have some higher standard errors. Everything that is significant for simple OLS is also significant to roughly the same extent for the FE models.
