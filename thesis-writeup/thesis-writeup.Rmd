...
After final submission a "Thank you screen" including virtual confetti indicated the end of the session and task (Figure \@ref(fig:thank-you)).

![(#fig:thank-you) End of task indication](./img/end_screen.png){width=80%}
