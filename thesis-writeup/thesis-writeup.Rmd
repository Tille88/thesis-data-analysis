...
Ware [@Ware20, p. 357] **TODO: DOES BIBTEX RESULT IN IBID?** also includes a figure which shows a fully opaque data encoding on top of a map layer (Figure `r figure_number`) – which depending on need can make it difficult for the end user to know the demarcations of the different categories due to occlusion.

 ![Fully opaque data encoding resulting in lower layers not being visible, possible resulting in the end user having difficulties knowing the exact underlying geography.](./img/picture1.png)
 ...
 **TODO: CITATION**
 ...
 ![Liberal web-GIS use of multiple encodings without clear data mapping clarifications for end-user (Ee, 2020).](./img/picture2.png)
...
**TODO: CITATION**
 ...
 ![Transparency data mapping/encoding for ArcGIS products (Berry, 2016)](./img/picture3.png)
...
**TODO: CITATION**
 ...
 ![Opacity data mapping and legend with colour scale (ArcGIS, 2020a)](./img/picture4.png)

**TODO: CITATION**
 
 ![Opacity data mapping and legend (ArcGIS, 2020b)](./img/picture5.png)
...
**Annotated Outline  (Figure `r figure_number`) ["Annotated" in tables], (Figure \ref{fig:annotated})**
