...
<!-- TODO: CHECK THAT page should start on an uneven page number on the right side of your open report. -->

\section{Introduction} \label{introduction}

## Data visualization and geographic information systems (GIS)

There are clear overlapping goals between the area of data visualization - with the target visually encoding data attributes in a way that is visually pleasing/easy for the target audience to decode - and visual representation of data on a map in a GIS-system. It may also be possible to consider visual representation of data for an end user in a GIS-system as a subfield of data visualization, and related fields such as the study of human perception, where most textbooks in these fields contains a section on geographic mapping of data [see e.g. @Munzner15, p. 181; @Grant19; @Cairo16; @Ware20, p. 105, 125, 128ff].


## Opacity/transparency in GIS visualizations

@Ware20 highlights this relation between the fields of Data Visualization and GIS in his seminal work on information visualization in relation to the use of transparency (alpha channel mapping/encoding) as a technique in information visualization:
...
@Ware20 [p. 357] also includes a figure which shows a fully opaque data encoding on top of a map layer (Figure \ref{opaque-data}) – which depending on need can make it difficult for the end user to know the demarcations of the different categories due to occlusion. In other words - fully opaque data encoding resulting in lower layers not being visible, resulting in the end user having difficulties referencing the underlying geography.

 ![Opaque data layer covering geographic information \label{opaque-data}](./img/picture1.png)




The increased accessibility and ease to create maps for online usage makes different data mappings openly available for a larger audience. There are a lot of maps that make liberal use of a mix of mapping techniques, such as colour and opacity [see Figure \ref{multiple-encodings}, @Ee20] without taking into account the end-users ability to easily decode the data being visualized.
 
 ![Example Web-GIS with multiple encodings channels without data mapping clarifications \label{multiple-encodings}](./img/picture2.png)
...
\footnote{
”Esri builds the leading mapping and spatial analytics software for desktop, software as a service (SaaS), and enterprise applications. Esri ArcGIS products are designed to deliver location intelligence and meet digital transformation needs for organizations of all sizes. Here you can explore Esri software, apps, content, solutions, and developer tools.” [@ArcgisIndex] **TODO, WHY NOT CITATION?**

”[…]our market-leading Enterprise GIS mapping software will support your work and deliver results” [@ArcgisPlatform] **TODO, WHY NOT CITATION?**

} 
ESRI/ArcGIS examples and tutorials for their products, such as “ArcGIS online” and “ArcGIS Enterprise Map Viewer” are shown by the blog-entry “6 Easy Ways to Improve Your Maps”, explicitly listing the use of transparency. The way in which the transparency tool works is included as well [Figure \ref{fig:opacity-picker}, @Berry2016] does not give the user much information or consider underlying layer colours and effects on perception.



This mapping has a similar visual representation to the end user of the maps as shown in the usage examples from the “ArcGIS Online” API documentation ArcGIS website (Figure \ref{fig:opacity-dark-background} [@ArcgisDarkOnline] and \ref{fig:opacity-bright-background} [@ArcgisBrightOnline]). Figure \ref{fig:opacity-dark-background} includes colour mapping, but the legend maps transparency into the same checkered grey/white background as for the tool shown in Figure \ref{fig:opacity-picker}, making it very difficult to decode the visual values. Figure \ref{fig:opacity-bright-background} has a single colour and a background layer corresponding roughly to the constant mid-grey and white checkered pattern.  
...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.25\textwidth}
         \centering
         \fbox{
         \includegraphics[width=\textwidth]{img/picture3.png}
         }
         \caption{Transparency data mapping/encoding for ArcGIS products}
         \label{fig:opacity-picker}
     \end{subfigure}
     ...
     \begin{subfigure}[b]{0.8\textwidth}
         ...
         \caption{Opacity data mapping and legend with colour scale}
     ...
     \begin{subfigure}[b]{0.8\textwidth}
         ...
         \caption{Opacity data mapping and legend}
...
In order to remove design choices of how to place this kind of legend around complex polygon shapes, a simple square-data area was chosen for all examples.
 ...
 \begin{figure}
     ...
     \begin{subfigure}[b]{0.42\textwidth}
         \centering
         \fbox{
         \includegraphics[width=\textwidth]{img/020-red-headline-legend-merge.png}
         }
         \caption{Baseline - No legend ["Headline"]}
         \label{fig:headline}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.42\textwidth}
         \centering
         \fbox{
         \includegraphics[width=\textwidth]{img/020-red-checkered-legend-merge.png}
         }
         \caption{Baseline2 – ArcGIS Imitation ["Checkered"]}
         \label{fig:checkered}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.42\textwidth}
         \centering
         \fbox{
         \includegraphics[width=\textwidth]{img/020-red-sampled-legend-merge.png}
         }
     ...
     \begin{subfigure}[b]{0.42\textwidth}
         \centering
         \fbox{
         \includegraphics[width=\textwidth]{img/020-red-clustered-legend-merge.png}
         }
     ...
     \begin{subfigure}[b]{0.42\textwidth}
         \centering
         \fbox{
         \includegraphics[width=\textwidth]{img/020-red-annotated-legend-merge.png}
         }
         \caption{Annotated Outline ["Annotated"]}
         \label{fig:annotated}
     \end{subfigure}
        \caption{Visualization legend types}
...
```{r abs-response-error-visualization, fig.cap = "Absolute error by visualization category", echo=FALSE}
...
```{r models-outlier-removal-plot, fig.cap = "Absolute error - 50th percentile most accurate respondent subset", echo=FALSE, message = FALSE}
# Absolute
