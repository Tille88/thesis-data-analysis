...
**Here you discuss the results by putting your findings in relation to what others published on the matter.**

**MAIN FINDINGS, INCLUSION OF LEGEND HELPS, COMPARED TO CHECKERED, NO STATISTICALLY SIGNIFICANT RESULTS, **

**SOURCES OF ERROR? QUITE LARGE NATURAL VARIATIONS, GIVEN RESPONDENT FEEDBACK, MAYBE LARGER LEGENDS COULD HAVE SOME OTHER RESULTS, MORE IN PARTS OF LOW OPACITY, IN IDEAL SETTING, EACH RESPONDENT WOULD ONLY GET ONE TREATMENT**

**LESS AND LESS RELIANT ON STATIC VISUALIZATION TYPES WITHOUT POSSIBILITY FOR INTERACTION**

**SOMEWHAT CONTRIVED EXAMPLES - ALL SQUARES, ONLY ONE DATA LAYER, IF MULTIPLE NON-OPAQUE LAYERS ARE USED THERE ARE ADDITIONAL COMPLEXITIES DUE TO HAVING POTENTIALLY OVERLAPPING OPACITY LAYERS**

**GEODATA PRACTICALLY ONLY IN EXAMPLES TO GIVE A MORE VARIED AND CLUTTERED BACKGROUND, RESULTS MAY DIFFER IN BACKGROUND HAVING LESS OR NO COLOURS, AS WELL AS FOR MORE COMPLEX BACKGROUNDS SUCH AS AERIAL/SATELLITE IMAGERY**

**SAMPLING: NON-RANDOM, DUE TO CONVENIENCE, AND FEASIBILITY OF DATA COLLECTION IN COVID. LARGE OVERSAMPLING OF ENGINEERS, SKEW FROM THIS DIFFICULT TO REASON ABOUT**

**NOT INCLUDED YET: COMPARISON TO OTHER PARTS OF LITERATURE, CAN SAY, LITTLE PUBLISHED ON THIS PARTICULAR QUESTION...**
