...
The increased accessibility and ease to create maps for online usage makes different data mappings available, there are a lot of maps that make liberal use of a mix of mapping techniques, such as colour and opacity (Figure \ref{multiple-encodings} [@Ee20]) without taking into account the end-users ability to easily decode the data being visualized.
 ...
 ![Liberal web-GIS use of multiple encodings without clear data mapping clarifications for end-user \label{multiple-encodings}](./img/picture2.png)
...
## Previous related literature **TODO: IMPROVE**
...
```{r models-outlier-removal-plot, fig.cap = "Box plot above 50th percentile most accurate respondent subset", echo=FALSE, message = FALSE}
# Absolute
