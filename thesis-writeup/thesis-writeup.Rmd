...
Table \@ref(tab:std-dev-by-cat) shows that the Headline types shows largest variance/standard deviation, followed by Checkered, Sampled, Clustered and Annotated legend types.
