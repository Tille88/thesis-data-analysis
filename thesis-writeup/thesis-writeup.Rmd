...
- **RQ4** - How are decision times and user selection behaviour affected by legend choices? 
...
\begin{itemize}
  ...
  \item In order to keep the designs similar for the decoding task, the size of the legends were chosen to imitate the ArcGIS design. Verbal feedback was given by one respondent that it would be useful to have larger legends.
